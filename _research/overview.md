...
<img src="/img/home_bmd.png" align="right" width="400px"/>
**Extended octahedron**
...
Perhaps the "holy grail" in the modeling of complex physical phenomena is to find **one** mathematical model that is
...
+ Computationally efficient to evaluate
  ...
  - Allowing for real-time computation
+ Supports high-dimensional/distributed parameters
  - Geometrical shapes for optimization
  - Control inputs for 
This one model can enable the integrated optimization of an autonomous engineering system involving 

multi-disciplinary analysis as well as simultaneous considerations of control and autonomy
...
[High-Fidelity Multi-Physics](#high-fidelity-multi-physics)
...
<img src="/img/post_2108.png" align="right" width="400px"/>
...
<img src="/img/post_2210_1.png" align="right" width="400px"/>
...
<img src="/img/post_2301_1.png" align="right" width="400px"/>
...
<img src="/img/post_2105.png" align="right" width="400px"/>
